...
module.exports = {
    ...
    run: async (client, message, args) => {
     ...
     if(channel) {
         ...
         message.reply({content: `> **:white_check_mark: ${channel} channel became visible**`, allowedMentions: {
            repliedUser: false
            }})
     } else {
         ...
         message.reply({content: `> **:white_check_mark: ${message.channel} channel became visible**`, allowedMentions: {
            repliedUser: false
            }})
     }
    },
